// Using Flutter's vector_math library directly
...
import 'package:sikayet_var/utils/debug_fix.dart';

// List extension metotları
import 'package:sikayet_var/utils/list_extensions.dart';

// Flutter web derlemesi için global polyfill desteği
import 'package:sikayet_var/utils/web_compat.dart' if (dart.library.io) 'package:sikayet_var/utils/io_compat.dart';

void main() {
  // Initialize timeago
  timeago.setLocaleMessages('tr', timeago.TrMessages());
  
  // Debug amaçlı güvenli log aracını başlat
  SafeDebugUtils.initialize();
  
  // Web için gerekli initizeleme
  if (kIsWeb) {
