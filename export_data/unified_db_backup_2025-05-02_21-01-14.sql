...
CREATE TABLE "award_types" (
  ...
  "min_rate" numeric NULL DEFAULT '0'::numeric,
  "max_rate" numeric NULL DEFAULT '100'::numeric,
...
CREATE SEQUENCE IF NOT EXISTS "cities_services_id_seq";

CREATE TABLE "cities_services" (
  "id" integer NOT NULL DEFAULT nextval('cities_services_id_seq'::regclass),
...
-- Tablo: cities_services için veri
-- Bu tablo boş, veri yok
