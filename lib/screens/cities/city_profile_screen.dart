    ...
    return Scaffold(
      body: cityProfileAsync.when(
        ...
        error: (error, stackTrace) => Center(
          child: Text('Şehir profili yüklenirken bir hata oluştu: $error'),
        ),
        data: (cityProfile) {
          return NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) {
              return [
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  title: _isCollapsed ? Text(cityProfile.name) : null,
                  flexibleSpace: FlexibleSpaceBar(
                    background: _buildCityHeader(cityProfile),
                  ),
            ...
            body: NotificationListener<ScrollNotification>(
              onNotification: (scrollNotification) {
                // Kaydırma olaylarını dinleyerek başlık görünürlüğünü ayarla
                if (scrollNotification is ScrollUpdateNotification) {
                  final ScrollMetrics metrics = scrollNotification.metrics;
                  setState(() {
                    _isCollapsed = metrics.pixels > 180;
                  });
                }
                return false;
              },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Şehir istatistikleri (icon'lar ile)
          ...
          Row(
            ...
            children: [
              ...
              _buildSolutionRatioIcon(
                context,
                cityProfile.totalSolvedIssues,
                cityProfile.totalPosts - cityProfile.totalSolvedIssues,
              ),
            ],
          ),
        ],
          ...
          child: Column(
            ...
            children: [
              ...
              if (cityProfile.contactPhone != null)
                _buildContactRow(context, Icons.phone, 'Telefon', cityProfile.contactPhone!),
              
              if (cityProfile.emergencyPhone != null)
                _buildContactRow(context, Icons.emergency, 'Acil Durum', cityProfile.emergencyPhone!),
              
              if (cityProfile.contactEmail != null)
                _buildContactRow(context, Icons.email, 'E-posta', cityProfile.contactEmail!),
              
              if (cityProfile.website != null)
                _buildContactRow(context, Icons.language, 'Web Sitesi', cityProfile.website!),
