...
-- Tablo: search_suggestions için veri
-- Bu tablo boş, veri yok
...
-- Tablo: before_after_records için veri
-- Bu tablo boş, veri yok
...
ALTER TABLE "before_after_records" ADD CONSTRAINT "before_after_records_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "posts" ("id") ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "before_after_records" ADD CONSTRAINT "before_after_records_recorded_by_fkey" FOREIGN KEY ("recorded_by") REFERENCES "users" ("id") ON UPDATE CASCADE ON DELETE CASCADE;
